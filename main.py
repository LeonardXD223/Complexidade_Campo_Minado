...
class Menu(Tk):
    ...
    def _create_examples(self):
        ...
        example_number_text: Label = Label(self,
                                           text=' E ao tocar com o botão esquerdo\nonde não há mina, o número de minas\npróximas é revelado',
                                           bg='gray60')
...
class Board(Tk):
    ...
    def _button_action(self, event, target_button: Button, right_click: bool = False) -> None:
        ...
        if right_click and (
                self.flag_matrix[target_x][target_y] == 'close' or self.flag_matrix[target_x][target_y] == 'mine'):
    ...
    def _create_flag_counter(self) -> None:
        ...
        self.flag_counter_label: Label = Label(self.flag_counter_frame, text=self.flags_amount,
                                               font=('Proggy Square', 15), bg='gray85')
